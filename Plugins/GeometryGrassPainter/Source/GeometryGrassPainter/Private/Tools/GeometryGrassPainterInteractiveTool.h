...
#include "GeometryGrassPainterInteractiveTool.generated.h"


/**
 * Builder for UGeometryGrassPainterInteractiveTool
 */
UCLASS()
class GEOMETRYGRASSPAINTER_API UGeometryGrassPainterInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UGeometryGrassPainterInteractiveTool
 */
UCLASS(Transient)
class GEOMETRYGRASSPAINTER_API UGeometryGrassPainterInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UGeometryGrassPainterInteractiveToolProperties();
...
/**
 * UGeometryGrassPainterInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class GEOMETRYGRASSPAINTER_API UGeometryGrassPainterInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UGeometryGrassPainterInteractiveToolProperties> Properties;

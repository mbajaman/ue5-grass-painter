...
#include "GeometryGrassPainterInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "UGeometryGrassPainterInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* UGeometryGrassPainterInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	UGeometryGrassPainterInteractiveTool* NewTool = NewObject<UGeometryGrassPainterInteractiveTool>(SceneState.ToolManager);
...
UGeometryGrassPainterInteractiveToolProperties::UGeometryGrassPainterInteractiveToolProperties()
{
...
void UGeometryGrassPainterInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void UGeometryGrassPainterInteractiveTool::Setup()
{
	...
	Properties = NewObject<UGeometryGrassPainterInteractiveToolProperties>(this, "Measurement");
...
void UGeometryGrassPainterInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit UGeometryGrassPainterInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UGeometryGrassPainterInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UGeometryGrassPainterInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UGeometryGrassPainterInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UGeometryGrassPainterInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void UGeometryGrassPainterInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UGeometryGrassPainterInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UGeometryGrassPainterInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{

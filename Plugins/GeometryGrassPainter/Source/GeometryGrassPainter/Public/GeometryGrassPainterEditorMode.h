...
#include "GeometryGrassPainterEditorMode.generated.h"
 ...
 */
UCLASS()
class UGeometryGrassPainterEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_GeometryGrassPainterEditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;

	UGeometryGrassPainterEditorMode();
	virtual ~UGeometryGrassPainterEditorMode();
